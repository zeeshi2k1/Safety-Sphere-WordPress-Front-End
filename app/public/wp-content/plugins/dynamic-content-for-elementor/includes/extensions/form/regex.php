...
class RegexField extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    public function update_fields_controls($widget)
    {
        ...
        $field_controls = ['field_regex' => ['name' => 'field_regex', 'label' => esc_html__('Regex', 'dynamic-content-for-elementor'), 'description' => esc_html__('A regular expression is a sequence of characters that define a pattern. Use it to restrict the characters permitted on this field.', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'separator' => 'before', 'return_value' => 'true', 'conditions' => ['terms' => [['name' => 'field_type', 'operator' => 'in', 'value' => ['text', 'email', 'url', 'password']]]], 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_enchanted_tab', 'tab' => 'enchanted']];
