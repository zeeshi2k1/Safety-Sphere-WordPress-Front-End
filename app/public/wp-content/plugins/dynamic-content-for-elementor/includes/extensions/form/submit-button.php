...
class SubmitButton extends \ElementorPro\Modules\Forms\Fields\Field_Base
{
    ...
    {
        return esc_html__('Submit', 'dynamic-content-for-elementor');
    }
    ...
    public function update_fields_controls($widget)
    {
        ...
        $field_controls = ['button_size' => ['name' => 'button_size', 'label' => esc_html__('Size', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SELECT, 'default' => 'sm', 'options' => Helper::get_button_sizes(), 'tabs_wrapper' => 'form_fields_tabs', 'tab' => 'content', 'inner_tab' => 'form_fields_content_tab']];
