...
class FieldLength extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    {
        return esc_html__('Length', 'dynamic-content-for-elementor');
    }
    /**
     * Add Actions
     *
