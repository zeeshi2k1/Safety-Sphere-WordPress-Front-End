...
class Control_XY_Movement extends Control_Base_Multiple
{
    ...
    {
        return ['x' => ['label' => esc_html__('X', 'dynamic-content-for-elementor'), 'min' => -200, 'max' => 200, 'step' => 1], 'y' => ['label' => esc_html__('Y', 'dynamic-content-for-elementor'), 'min' => -200, 'max' => 200, 'step' => 1]];
    }
    /**
