...
class Control_Transforms extends Control_Base_Multiple
{
    ...
    {
        return ['angle' => ['label' => esc_html__('Angle', 'dynamic-content-for-elementor'), 'min' => -360, 'max' => 360, 'step' => 1], 'rotate_x' => ['label' => esc_html__('Rotate X', 'dynamic-content-for-elementor'), 'min' => -360, 'max' => 360, 'step' => 1], 'rotate_y' => ['label' => esc_html__('Rotate Y', 'dynamic-content-for-elementor'), 'min' => -360, 'max' => 360, 'step' => 1], 'translate_x' => ['label' => esc_html__('Translate X', 'dynamic-content-for-elementor'), 'min' => -1000, 'max' => 1000, 'step' => 1], 'translate_y' => ['label' => esc_html__('Translate Y', 'dynamic-content-for-elementor'), 'min' => -1000, 'max' => 1000, 'step' => 1], 'translate_z' => ['label' => esc_html__('Translate Z', 'dynamic-content-for-elementor'), 'min' => -1000, 'max' => 1000, 'step' => 1], 'scale' => ['label' => esc_html__('Scale', 'dynamic-content-for-elementor'), 'min' => 0.1, 'max' => 3, 'step' => 0.1]];
    }
