...
trait Elementor
{
    ...
    {
        if ($default) {
            $templates[0] = esc_html__('Default', 'dynamic-content-for-elementor');
            $templates[1] = esc_html__('None', 'dynamic-content-for-elementor');
        } else {
            $templates[0] = esc_html__('None', 'dynamic-content-for-elementor');
        }
